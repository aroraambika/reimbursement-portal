...
$menu_link_for_mgr=array('welcome_emp.php','emp_profile.php','emp_claim.php','allclaimfrtrack.php','claim_req.php','claimfremp.php');
  ...
  if (isset($_SESSION["emailid"])) {
    ...
    if($type=='emp')
    {
          ...
          echo "<li class='active blue lighten-4'><a href=".$menu_link_for_emp[2]." class='waves-effect blue-text'><i class='material-icons blue-text'>library_books</i>".$menu_items_for_emp[2]."</li>";
      ...
      echo "<li class='active blue lighten-4'><a href=".$menu_link_for_mgr[2]." class='waves-effect blue-text'><i class='material-icons blue-text'>library_books</i>".$menu_items_for_mgr[2]."</li>";//notifications
    ...
    $result=mysqli_query($con,$sql);
        ...
        if(mysqli_num_rows($result)>0){
            ...
            echo "<div class='col s12'>List of Submitted Claims</div>";
          ...
          //  echo "<hr>";
            ...
            echo "<th class='blue-text'>Cost Center</th>";
            echo "<th class='blue-text'>Status</th>";
            echo "<th class='blue-text'>Bill Picture</th>";
            echo "</tr>";
                ...
                while($row=mysqli_fetch_assoc($result)){
                  ...
                  echo "<td><u><a href='$pic'>" . $row["billpic"]. "</a></u></td>";
                  echo "</tr>";
                }
                  echo "</table>";
 ...
 <head>
     <title>List of Submitted Claims</title>
